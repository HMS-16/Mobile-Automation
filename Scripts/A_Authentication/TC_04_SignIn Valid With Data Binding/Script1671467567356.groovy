...
if ((email == 'azhar@gmail.com') && (password == 'azhar')) {
    Mobile.verifyElementVisible(findTestObject('Invalid_SignIn_And_SignUp/Validation_Admin Page'), 0 //if ((email == '') || ((email.contains('@gmail.com') == false) || (email.contains('@hms.com') == false)) {
        )
} else {
    Mobile.verifyElementVisible(findTestObject('Invalid_SignIn_And_SignUp/Validation_Welcome_Message'), 0)
}
